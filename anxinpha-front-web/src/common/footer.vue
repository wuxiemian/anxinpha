    ...
    <div class="container">
      <div class="siteinfo">
        <ul class="c0">
          <h3 class="c1">关于网站</h3>
          <ul>
            <li class="c2"><a class="c3" @click="open6">网站作者</a></li>
            <li class="c2"><a class="c3" @click="open7">网站架构</a></li>
          </ul>
        </ul>
        <ul class="c0">
          <h3 class="c1">订单服务</h3>
        ...
        <ul class="c0">
          <h3 class="c1">售后服务</h3>
          <ul>
            <li class="c2"><a class="c3" @click="open8">售后服务</a></li>
            <li class="c2"><a class="c3" @click="open8">售后服务</a></li>
          </ul>
        </ul>

        <ul class="c4">
          <li class="tel"><a class="c5"  target="_blank">1111111111</a></li>
          <li class="time">周一至周日 10:00-23:00（没人接听的）</li>
          <li class="online">
      ...
      <div class="copyright">
        <h4 class="content-c2">Copyright ©2017, anxin.com Co., Ltd. All Rights Reserved.</h4>
        <ul class="privacy">
          <li class="content-c1"><a class="content-c0" @click="open1">法律声明</a></li>
          <li class="content-c1"><a class="content-c0" @click="open2">隐私条款</a></li>
          <li class="content-c1"><a class="content-c0" target="_blank" href="https://github.com/wumianye">开发者中心</a></li>
        </ul>
      </div>
      <div class="cop">
