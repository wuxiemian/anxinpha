    ...
    <div style="">
      <div class="good-img">
        <a @click="openProduct(msg.id)">
          <img v-lazy="msg.imageBig" :alt="msg.title" :key="msg.imageBig">
        </a>
      </div>
      ...
      <div class="good-price pr">
        <div class="ds pa">
          ...
          <y-button text="加入购物车"
                    style="margin: 0 5px"
                    @btnClick="addCart(msg.id,msg.price,msg.title,msg.imageBig)"
                    classStyle="main-btn"
          ></y-button>
        </div>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      openProduct (id) {
        window.open('//' + window.location.host + '/#/goodsDetails?goodsId=' + id)
      },
