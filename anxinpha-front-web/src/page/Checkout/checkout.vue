...
<!--              </div>-->
              买家留言：<el-input v-model="buyerMessage" type="text" style="width: 300px;"></el-input>
              <div class="fix-bottom-inner">
                <div class="shipping">
                  <div class="shipping-box" style="padding: 0 40px;">
                    <input v-model="paymentType" name="paymentType" value="1" type="radio" checked="checked">在线支付
                    <input v-model="paymentType" name="paymentType" value="2" type="radio">货到付款
  ...
  export default {
    ...
    methods: {
      ...
      _submitOrder () {
        ...
        axios.post('http://api.anxinpha.com/api/user/addOrder', params).then(res => {
          if (res.data) {
      ...
      _productDet (productId) {
        productDet({params: {goodsId: productId}}).then(res => {
          let item = res.result
          item.checked = '1'
