          ...
          <div class="content" style="margin-top: 20px;">
            <ul class="common-form">
              ...
              <li>
                <div class="input">
                  <input type="text"
                         ...
                         placeholder="手机号"
                         @blur="checkuser(2, registered.phone)">
                </div>
              </li>
              <li>
                <div class="input">
                  <input type="text"
                         ...
                         placeholder="邮箱"
                         @blur="checkuser(3, registered.email)">
                </div>
              </li>
              <li>
                <div class="input">
              ...
              <li>
                <div class="input">
                <input type="text"
                       v-model="registered.captcha" placeholder="验证码">
                </div>
                  <img v-model="img" width="116" height="36" :src="caurl" v-on:click="init_captcha()">
  ...
  methods: {
      ...
      register({
        ...
        statusKey: this.statusKey }).then(res => {
          if (res === 1) {
            ...
            this.message(res.errors[0].defaultMessage)
            this.refresh()
          }
        })
    },
    init_captcha () {
      captchainit().then(res => {
        uuid = res
        this.caurl = 'http://api.anxinpha.com/api/user/captcha/draw/' + uuid + '?t=' + (new Date()).getTime()
      })
    }
  },
  mounted () {
