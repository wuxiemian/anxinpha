  ...
  <div>
    <y-shelf title="开通店铺">
      <div slot="content">
        ...
        <div>
          &nbsp;&nbsp;&nbsp;&nbsp;店铺名称：<el-input v-model="shopName" style="width:300px;"></el-input>
          <br/>
          <br/>
          &nbsp;&nbsp;&nbsp;&nbsp;店铺介绍：<el-input v-model="shopDesc" style="width:300px;"></el-input>
          <br/>
          <y-button text="立即开通" :classStyle="shopName?'main-btn':'disabled-btn'" style="margin-top: 20px;margin-left: 100px;margin-bottom: 20px;" @btnClick="addShop" align="center"></y-button>
        </div>
...
<script>
  ...
  import { upload, openShop } from '/api/index'
  ...
  export default {
    ...
    methods: {
      ...
      addShop () {
        ...
        var that = this
        openShop(params).then(res => {
          if (res) {
            that.messageSuccess('开通成功')
            window.location.href = 'http://www.anxinpha.com'
          } else {
            that.messageFail('开通失败')
            window.location.href = 'http://www.anxinpha.com'
          }
        })
      },
