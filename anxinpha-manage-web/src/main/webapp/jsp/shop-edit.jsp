...
<script type="text/javascript">
    ...
    $("#id").val(parent.Id);
    $("#shopName").val(parent.shopName);
    $("#shopicon").attr("src",parent.shopIcon);
    if (parent.shopDesc=="该店铺暂无描述"){
        $("#shopDesc").attr("placeholder",parent.shopDesc);
    }else {
        $("#shopDesc").val(parent.shopDesc);
    }
