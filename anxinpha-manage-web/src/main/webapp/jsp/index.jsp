        ...
        <dl id="menu-product">
            ...
            <dd>
                <ul>
                    ...
                    <li><a data-href="goods-list" data-title="商品列表" href="javascript:void(0)">商品列表</a></li>
                </ul>
            </dd>
        </dl>
        <dl id="menu-order">
...
<%--        </dl>--%>
        <dl id="menu-shop">
            ...
            <dd>
                <ul>
                    <li><a data-href="shop-list" data-title="店铺列表" href="javascript:void(0)">店铺列表</a></li>
                </ul>
            </dd>
        </dl>
<%--        <dl id="menu-comments">--%>
...
<%--                    <li><a data-href="http://localhost:10010/api/item/test" data-title="测试" href="javascript:void(0)">测试111</a></li>--%>
<%--                </ul>--%>
<%--            </dd>--%>
<%--        </dl>--%>
        <dl id="menu-member">
