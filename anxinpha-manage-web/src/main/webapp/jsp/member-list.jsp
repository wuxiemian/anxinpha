...
<script type="text/javascript">
    ...
    function member_stop(obj,id){
        layer.confirm('确认要停用ID为\''+id+'\'的会员吗？',{icon:0},function(index){
            ...
            $.ajax({
                type: 'PUT',
                url: 'http://api.anxinpha.com/api/item/member/stop/'+id,
                success: function(data){
                    layer.close(index);
                    refresh();
    ...
    function member_start(obj,id){
        layer.confirm('确认要启用ID为\''+id+'\'的会员吗？',{icon:3},function(index){
            ...
            $.ajax({
                type: 'PUT',
                url: 'http://api.anxinpha.com/api/item/member/start/'+id,
                success: function(data){
                    layer.close(index);
                    refresh();
    ...
    function member_del(obj,id){
        layer.confirm('确认要删除ID为\''+id+'\'的会员吗？',{icon:0},function(index){
            ...
            $.ajax({
                type: 'PUT',
                url: 'http://api.anxinpha.com/api/item/member/remove/'+id,
                success: function(data){
                    layer.close(index);
                    member_count();
                    refresh();
    ...
    function datadel() {
        ...
        layer.confirm('确认要删除所选的'+count+'条数据吗？',{icon:0},function(index){
            ...
            $.ajax({
                type: 'PUT',
                url: 'http://api.anxinpha.com/api/item/member/remove/'+ids,
                success:function(data){
                    layer.close(index);
                    layer.msg('已删除!',{icon:1,time:1000});
                    member_count();
