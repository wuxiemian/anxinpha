...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        $('.table').DataTable({
            ...
            "ajax": {
                url:"http://api.anxinpha.com/api/item/order/list",
                type: 'GET',
            },
            "columns": [
                { "data": null,
    ...
    function orderCount() {
        $.ajax({
            url:"http://api.anxinpha.com/api/item/order/count",
            type: 'GET',
    ...
    function order_cancel(id){
        layer.confirm('确认要取消ID为\''+id+'\'的订单吗？',{icon:0},function(index){
            ...
            $.ajax({
                type: 'GET',
                url: 'http://api.anxinpha.com/api/item/order/cancel/'+id,
                success: function(data){
                    layer.close(index);
                    refresh();
    ...
    function order_del(obj,id){
        layer.confirm('确认要删除ID为\''+id+'\'的订单吗？',{icon:0},function(index){
            ...
            $.ajax({
                type: 'DELETE',
                url: 'http://api.anxinpha.com/api/item/order/del/'+id,
                success: function(data){
                    layer.close(index);
                    orderCount();
                    refresh();
