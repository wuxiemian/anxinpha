    ...
    <form name="goods-add" action="" method="post" class="form form-horizontal" id="goods-add">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input id="title" type="text" class="input-text" value="" placeholder="" name="title">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>简介描述：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input id="sellPoint" type="text" class="input-text" value="" placeholder="" name="sellPoint">
            </div>
        </div>
        <div class="row cl">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input id="price" type="text" name="price" placeholder="请输入正确金额" value="" class="input-text" style="width:50%">
                元</div>
        </div>
        <div class="row cl">
        ...
        <img id="image1" width="80" height="80">
...
<script type="text/javascript">
    ...
    $("#goods-add").validate({
        ...
        submitHandler:function(form){
            ...
            $(form).ajaxSubmit({
                url: "http://api.anxinpha.com/api/item/goods/update",
                type: "PUT",
    ...
    editor.create();
    detailtext.val(editor.txt.html());
    editdata();
    function editdata(){
        $.ajax({
            type: 'GET',
            url: 'http://api.anxinpha.com/api/item/goods/'+parent.getId(),
            dataType: 'json',
            success: function(data){
                $("#id").val(parent.getId());
