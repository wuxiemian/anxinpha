...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        $('.table').DataTable({
            ...
            "ajax": {
                url:"http://api.anxinpha.com/api/user/allorder",
                type: 'GET',
            },
            ...
            "columns": [
                ...
                { "data": "payment"},
                { "data": "buyerNick"},
                { "data": "shippingCode","defaultContent":""},
                { "data": "buyerMessage","defaultContent":""},
                { "data": "createTime",
                    render : function(data,type, row, meta) {
                        return date(data);
                    }
    ...
    function orderCount() {
        $.ajax({
            url:"http://api.anxinpha.com/api/user/orderCount",
            type: 'GET',
    ...
    function order_cancel(id){
        layer.confirm('确认要取消ID为\''+id+'\'的订单吗？',{icon:0},function(index){
            ...
            $.ajax({
                type: 'PUT',
                url: 'http://api.anxinpha.com/api/user/cancelOrder',
                data: {
                    orderId:id
                },
                success: function(data){
    ...
    function order_del(obj,id){
        layer.confirm('确认要删除ID为\''+id+'\'的订单吗？',{icon:0},function(index){
            ...
            $.ajax({
                type: 'DELETE',
                url: 'http://api.anxinpha.com/api/user/delOrder/'+id,
                success: function(data){
                    layer.close(index);
                    orderCount();
                    refresh();
    ...
    function datadel() {
        ...
        layer.confirm('确认要删除所选的'+count+'条数据吗？',{icon:0},function(index){
            ...
            $.ajax({
                type: 'DELETE',
                url: 'http://api.anxinpha.com/api/item/order/del/'+ids,
                success:function(data){
                    layer.close(index);
                    layer.msg('已删除!',{icon:1,time:1000});
                    orderCount();
